defmodule Lilac.Pagination do
  ...
  @spec generate(integer, Lilac.Pagination.Input.t() | nil, Absinthe.Resolution.t() | nil) ::
          Lilac.Pagination.t()
  def generate(count, maybe_page_input, info \\ %Absinthe.Resolution{}) do
    if Lilac.GraphQLHelpers.Introspection.requested_pagination?(info) do
